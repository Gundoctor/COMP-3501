...
Camera::Camera() : GameEntity(), shipVel(0)
{
...
void Camera::CameraMove(float ahead, float updown)
{
...
void Camera::CameraSpin(float roll, float pitch, float yaw)
{
...
XMVECTOR Camera::getLeft()
{
	return left;
}

void Camera::setFor(XMVECTOR ahead)
{
	forward = ahead;
}

void Camera::setUp(XMVECTOR sky)
{
	up = sky;
}
